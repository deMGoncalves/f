import oneParameter from '@/curry/oneParameter'
import twoParameters from '@/curry/twoParameters'
import threeParameters from './threeParameters'
import __, { isGap } from '@/gap'

jest.mock('@/curry/oneParameter')
jest.mock('@/curry/twoParameters')
jest.mock('@/gap')
